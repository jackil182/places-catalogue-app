...
function ajaxHeart(e) {
  ...
  e.preventDefault();
  _axios2.default.post(this.action) // this = DOM Element (form), action - is it's attribute
  .then(function (res) {
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    var markers = places.map(function (el) {
      var _el$location$coordina = _slicedToArray(el.location.coordinates, 2),
          placeLng = _el$location$coordina[0],
          placeLat = _el$location$coordina[1];
    ...
    markers.forEach(function (el) {
      return el.addListener('click', function () {
        // addListener is google's alternative to addEvenetListener
        var marker = this;
